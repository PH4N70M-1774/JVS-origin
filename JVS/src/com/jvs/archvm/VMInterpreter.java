...
/**
 * Interprets the instructions of the JVS Virtual Machine (ArchVM).
 * <p>
 *
 *
 * =============================[NOTE]=============================
 * <p>
 * Please read the documentation of the methods defined by this
 * <p>
 * by this class as the names given to the methods are such that
 * <p>
 * they match the instructions of the JVS Bytecode (IS-SC23).
 * <p>
 * This has lead to many weird names which are not easy to
 * <p>
 * understand(Which is usually a bad practice by the programmer
 * <p>
 * as he is expected to give clear names to his methods for more
 * <p>
 * convenience.)
 * <p>
...
public class VMInterpreter {
     ...
     *
     * @param main VarManager object to store main variables of a class.
     *             <p>
     * @param temp VarManager object to store temporary variables of a class (The
     *             temporary variables are not present in the source code, but in
     *             the bytecode).
     *             <p>
     */
    ...
    /**
     * Interprets the 'clrmainl' function in the ArchVM Bytecode.
     * <p>
     * The 'clrmainl' function clears the main variable list (main VarManager
     * object).
     * <p>
     */
    ...
    /**
     * Interprets the 'clrtlist' function in the ArchVM Bytecode.
     * <p>
     * The 'clrtlist' function clears the temporary variable list (temp VarManager
     * object).
     * <p>
     */
    ...
    /**
     * Interprets the 'put' function in the ArchVM Bytecode.
     * <p>
     * The 'put' function adds a variable into the main VarManager object.
     * <p>
     *
    ...
    /**
     * Interprets the 'set' function in the ArchVM Bytecode.
     * <p>
     * The 'set' function sets a new value for an existing main variable.
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'cast' function in the ArchVM Bytecode.
     * <p>
     * The 'cast' function casts a variable of one type to another type.
     * <p>
     * A 'cast' instruction has the following format: cast type1, type2, name,
     * target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
    ...
    /**
     * Interprets the 'iadd' function in the ArchVM Bytecode.
     * <p>
     * The 'iadd' function adds two integers and stores the value in another
     * variable.
     * <p>
     * An 'iadd' instruction has the following format: iadd v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'fadd' function in the ArchVM Bytecode.
     * <p>
     * The 'fadd' function adds two floats and stores the value in another variable.
     * <p>
     * A 'fadd' instruction has the following format: fadd v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'isub' function in the ArchVM Bytecode.
     * <p>
     * The 'isub' function subtracts two integers and stores the value in another
     * variable.
     * <p>
     * An 'isub' instruction has the following format: isub v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'fsub' function in the ArchVM Bytecode.
     * <p>
     * The 'fsub' function subtracts two floats and stores the value in another
     * variable.
     * <p>
     * A 'fsub' instruction has the following format: fsub v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * The following two methods interpret the instructions related to
     * multiplication.
     */

    /**
     * Interprets the 'imult' function in the ArchVM Bytecode.
     * <p>
     * The 'imult' function multiplies two integers and stores the value in another
     * variable.
     * <p>
     * An 'imult' instruction has the following format: imult v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'fmult' function in the ArchVM Bytecode.
     * <p>
     * The 'fmult' function multiplies two floats and stores the value in another
     * variable.
     * <p>
     * A 'fmult' instruction has the following format: fmult v1, v2, target
     * <p>
     * <p>
     *
     * @param args Contains the arguments of the instruction.
    ...
    /**
     * Interprets the 'idiv' function in the ArchVM Bytecode.
     * <p>
     * The 'idiv' function divides two integers and stores the value in another
     * variable.
     * <p>
     * An 'idiv' instruction has the following format: idiv v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'fdiv' function in the ArchVM Bytecode.
     * <p>
     * The 'fdiv' function divides two floats and stores the value in another
     * variable.
     * <p>
     * A 'fdiv' instruction has the following format: fdiv v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'imod' function in the ArchVM Bytecode.
     * <p>
     * The 'imod' function performs modulus operation on two integers and stores the
     * value in another variable.
     * <p>
     * An 'imod' instruction has the following format: imod v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'fmod' function in the ArchVM Bytecode.
     * <p>
     * The 'fmod' function adds two floats and stores the value in another variable.
     * <p>
     * A 'fmod' instruction has the following format: fmod v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'ipow' function in the ArchVM Bytecode.
     * <p>
     * The 'ipow' function raises an integer to the power of another integer and
     * stores the value in another variable.
     * <p>
     * An 'ipow' instruction has the following format: ipow v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'fpow' function in the ArchVM Bytecode.
     * <p>
     * The 'fpow' function raises a float to the power of another float and stores
     * the value in another variable.
     * <p>
     * An 'fpow' instruction has the following format: fpow v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'incr' function in the ArchVM Bytecode.
     * <p>
     * The 'incr' function increments a int/float variable by one.
     * <p>
     * An 'incr' instruction has the following format: incr v
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'decr' function in the ArchVM Bytecode.
     * <p>
     * The 'decr' function increments a int/float variable by one.
     * <p>
     * An 'decr' instruction has the following format: decr v
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'cmpgt' function in the ArchVM Bytecode.
     * <p>
     * The 'cmpgt' function checks if v1 > v2 and stores a boolean value in another
     * variable.
     * <p>
     * A 'cmpgt' instruction has the following format: cmpgt v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'cmpgte' function in the ArchVM Bytecode.
     * <p>
     * The 'cmpgte' function checks if v1 >= v2 and stores a boolean value in
     * another variable.
     * <p>
     * A 'cmpgte' instruction has the following format: cmpgte v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'cmplt' function in the ArchVM Bytecode.
     * <p>
     * The 'cmplt' function checks if v1 < v2 and stores a boolean value in another
     * variable.
     * <p>
     * A 'cmplt' instruction has the following format: cmplt v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'cmplte' function in the ArchVM Bytecode.
     * <p>
     * The 'cmplte' function checks if v1 <= v2 and stores a boolean value in
     * another variable.
     * <p>
     * A 'cmplte' instruction has the following format: cmplte v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'cmpe' function in the ArchVM Bytecode.
     * <p>
     * The 'cmpe' function checks if v1 == v2 and stores a boolean value in another
     * variable.
     * <p>
     * A 'cmpe' instruction has the following format: cmpe v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'cmpne' function in the ArchVM Bytecode.
     * <p>
     * The 'cmpne' function checks if v1 != v2 and stores a boolean value in another
     * variable.
     * <p>
     * A 'cmpne' instruction has the following format: cmpne v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'and' function in the ArchVM Bytecode.
     * <p>
     * The 'and' function stores the value of v1 && v2 in target.
     * <p>
     * A 'and' instruction has the following format: and v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'or' function in the ArchVM Bytecode.
     * <p>
     * The 'or' function stores the value of v1 || v2 in target.
     * <p>
     * A 'or' instruction has the following format: or v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'xor' function in the ArchVM Bytecode.
     * <p>
     * The 'xor' function stores the value of v1 && v2 in target.
     * <p>
     * A 'xor' instruction has the following format: xor v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'not' function in the ArchVM Bytecode.
     * <p>
     * The 'not' function stores the value of !v1 in target.
     * <p>
     * A 'not' instruction has the following format: not v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'eq' function in the ArchVM Bytecode.
     * <p>
     * The 'eq' function stores the value of v1 == v2 in target.
     * <p>
     * A 'eq' instruction has the following format: eq v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'neq' function in the ArchVM Bytecode.
     * <p>
     * The 'neq' function stores the value of v1 != v2 in target.
     * <p>
     * A 'neq' instruction has the following format: neq v1, v2, target
     * <p>
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    /**
     * Interprets the 'assert' function in the ArchVM Bytecode.
     * <p>
     * The 'assert' function checks if a condition is true and accordingly return a
     * line number to jump to.
     * <p>
     * An 'assert' function has the following format: assert bool_value true_line,
     * false_line
     * <p>
    ...
    /**
     * Interprets the 'goto' function in the ArchVM Bytecode.
     * <p>
     * The 'goto' function is used to jump to a line in the .jvse file.
     * <p>
     * An 'goto' function has the following format: goto line
     * <p>
     ...
     * A 'print' function has the following format: print
     * args_separated_by_comma_and_space (", ")
     *
     * @param args Contains the arguments of the instruction.
     */
    ...
    private Class<?> mapTypeCodeToClass(int typeCode) {
        switch (typeCode) {
            case 1:
                return long.class; // jvs int = Java long
            case 2:
                return double.class; // jvs float/double
            case 3:
                return char.class; // jvs char
            case 4:
                return boolean.class; // jvs boolean
            default:
                return Object.class;
        }
    }
    ...
    private Object getVariableValueBoxed(String varName, int typeCode) {
        if (varName.startsWith("$")) {
            switch (typeCode) {
                case 1:
                    return Long.valueOf(temp.getIntVar(varName));
                case 2:
                    return Double.valueOf(temp.getFloatVar(varName));
                case 3:
                    return Character.valueOf(temp.getCharVar(varName));
                case 4:
                    return Boolean.valueOf(temp.getBoolVar(varName));
            }
        } else {
            switch (typeCode) {
                case 1:
                    return Long.valueOf(main.getIntVar(varName));
                case 2:
                    return Double.valueOf(main.getFloatVar(varName));
                case 3:
                    return Character.valueOf(main.getCharVar(varName));
                case 4:
                    return Boolean.valueOf(main.getBoolVar(varName));
            }
        }
        return null;
    }

    // Store returned value to main or temp VarManager, handling type conversion if
    // needed
    private void setVariableValue(String varName, Object value) {
        ...
        if (value instanceof Long) {
            if (isTemp)
                temp.setVar(varName, (Long) value);
            else
                main.setVar(varName, (Long) value);
        } else if (value instanceof Double) {
            if (isTemp)
                temp.setVar(varName, (Double) value);
            else
                main.setVar(varName, (Double) value);
        } else if (value instanceof Character) {
            if (isTemp)
                temp.setVar(varName, (Character) value);
            else
                main.setVar(varName, (Character) value);
        } else if (value instanceof Boolean) {
            if (isTemp)
                temp.setVar(varName, (Boolean) value);
            else
                main.setVar(varName, (Boolean) value);
        } else {
            // handle Object or other types if needed
        }
    }

    // Dummy placeholder, you must implement this to return your variable's type
    // code (1-4)
    ...
    /**
     * Checks if the two types are compatible for casting.
     * <p>
    ...
    private boolean isCompatible(String type1, String type2) {
        return isIn(type1, new String[] { "int", "float", "char" })
                && isIn(type2, new String[] { "int", "float", "char" });
    }
    ...
    /**
     * This method logs a VM Error with the message specified by the message
     * parameter and
    ...
    /**
     * This method is a helper method used by methods associated with logical
     * operations to get
     * <p>
